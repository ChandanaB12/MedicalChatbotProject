...
const downloadReport = (msg) => {
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://medicalchatbotproject.onrender.com/predict",
        {
          symptom: symptom,
        }
      );
  ...
  <div className="flex-1 bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-blue-100 p-6 flex flex-col">
    ...
    <div className="flex-1 overflow-y-auto mb-4">
     ...
     {loading && (
  <div className="flex items-center gap-4 bg-blue-50 border border-blue-200 rounded-2xl p-3 mb-4 shadow">
    ...
    <div>
      ...
      {messages.length === 0 ? (
       ...
       <div className="bg-gradient-to-br from-blue-50 via-cyan-50 to-white border border-blue-200 rounded-3xl p-6 shadow-xl">
  ...
  <div className="grid grid-cols-2 gap-3 mt-6">
    ...
    <div className="bg-white rounded-2xl p-4 shadow text-center">
      <div className="text-2xl">💊</div>
      <p className="font-semibold mt-1 text-sm">Medicines</p>
    </div>

    <div className="bg-white rounded-2xl p-4 shadow text-center">
      <div className="text-3xl">🥗</div>
      <p className="font-semibold mt-1 text-sm">Diet Plan</p>
    </div>

    <div className="bg-white rounded-2xl p-4 shadow text-center">
      <div className="text-3xl">🏥</div>
      <p className="font-semibold mt-1 text-sm">Hospitals</p>
    </div>

    <div className="bg-white rounded-2xl p-4 shadow text-center">
      <div className="text-3xl">🚨</div>
      <p className="font-semibold mt-1 text-sm">Emergency Alert</p>
    </div>

  </div>

  <div className="mt-6 bg-green-50 border border-green-200 rounded-2xl p-3">
  ...
  <div>
    ...
    <p className="text-sm text-gray-500">
      Healthcare Assistant
             ...
             {msg.response.prediction === "More Symptoms Required" ? (

  <div className="bg-yellow-100 border-l-4 border-yellow-500 rounded-xl p-4 mt-3 shadow-sm">
  ...
  <>
    <div className="bg-purple-50 border-l-4 border-purple-500 rounded-xl p-4 mt-3 shadow-sm">
